        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card mb-4 box-shadow">
              ...
              <div class="card-body">
                <h5 class="jumbotron-heading"><b>Bussiness Name </b>- {{$user->supplierDetail->business_name}}</h5>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    ...
                    <a href="{{route('booking.cylinder')}}/{{base64_encode($user->id)}}" class="btn btn-primary btn-sm">View</a>
