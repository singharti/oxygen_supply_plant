...
<div class="container">
    ...
    @endif
    <form class="form-horizontal" method="post" role="form" action="{{ route('register.supplier') }}" enctype="multipart/form-data">
        @csrf
        <h2>Registration</h2>
        <div class="form-group">
            <label for="businessname" class="col-sm-3 control-label">Business Name*</label>
            <div class="col-sm-9">
                <input type="text" id="businessname" placeholder="Business Name" class="form-control @error('businessname') is-invalid @enderror" name="businessname" value="{{ old('businessname') }}">
                @error('businessname')
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="name" placeholder="Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}">
                @error('name')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="password" id="password" placeholder="Password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}">
                @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="password" id="confirm_password" placeholder="Password" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password" value="{{ old('confirm_password') }}">
